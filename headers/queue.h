 ...
 * @param[in,out] queue Pointer to the queue  
 * @return Front element value if successful, appropriate MACRO in case of failure
 */
 ...
 * @return Front elements value if successful, appropriate MACRO in case of failure
 */
